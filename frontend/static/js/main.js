...
const translations = {
    en: {
        ...
        'earnings.weeklyPremium': 'Weekly Premium:',
        'earnings.calls': 'Calls:',
        'earnings.puts': 'Puts:',
        'earnings.total': 'Total:',
        'earnings.weeklyReturn': 'Weekly Return:',
        'earnings.annual': 'Annual:',
        'earnings.projectedIncome': 'Projected Income:',
        'earnings.projectedNote': 'Projected earnings assume selling the same options weekly for 52 weeks (annualized).',
        ...
        'close.safetyNote': 'Adding this order does not send it to IB. Execution still requires a separate confirmation.',
    ...
    zh: {
        ...
        'earnings.weeklyPremium': '每周权利金：',
        'earnings.calls': '看涨：',
        'earnings.puts': '看跌：',
        'earnings.total': '合计：',
        'earnings.weeklyReturn': '周回报：',
        'earnings.annual': '年化：',
        'earnings.projectedIncome': '预估年收入：',
        'earnings.projectedNote': '预估收益假设每周卖出同样的期权并按 52 周年化。',
        ...
        'close.safetyNote': '添加订单不会发送到 IB，仍需在待处理订单中再次确认执行。',
